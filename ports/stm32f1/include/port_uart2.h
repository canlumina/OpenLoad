/*
 * STM32F1 Port - UART2 裸驱动 (供 ESP8266 / 其它 AT 模块使用)
 *
 * 引脚:  PA2 = TX,  PA3 = RX
 * 时钟:  APB1 36 MHz
 * DMA:   RX = DMA1_Channel6 循环, TX = DMA1_Channel7 普通 (M1 阶段 TX 仍走阻塞)
 * IRQ:   USART2_IRQn(5), DMA1_Channel6_IRQn(4), DMA1_Channel7_IRQn(4)
 *
 ...
 * 与 stm32f1xx_it.c 的 USART2_IRQHandler 分发调用 */
